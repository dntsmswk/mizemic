...
public class Enemy2_Make : MonoBehaviour
{
            ...
            if (distan1[i] > distan2[i])
            {
                if (distan1[i] > distan3[i])
                {
                    if (distan1[i] > distan4[i])
                    {
                        ...
                        Debug.Log("길이 1이 가장 큼");
                    }
                }
                else if(distan3[i]>distan4[i])
                {
                    Instantiate(enemy, enemyLine3.transform.position, enemyLine2.transform.rotation);
                    Debug.Log("길이 3이 가장 큼");
                }
                else
                {
                    Instantiate(enemy, enemyLine4.transform.position, enemyLine2.transform.rotation);
                    Debug.Log("길이 4이 가장 큼");
                }
            }
